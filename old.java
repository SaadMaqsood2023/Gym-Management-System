...
public class Update_trainer extends JFrame implements ActionListener
{
    ...
    Update_trainer()
    {
        ...
        ImageIcon img_c = new ImageIcon(ClassLoader.getSystemResource("MyProjectForms/Icons/Gym_Trainer_img.jpg"));
        Image img = img_c.getImage().getScaledInstance(270,600,Image.SCALE_DEFAULT);
            ...
            public void mouseClicked(MouseEvent arg0) {
                ...
                try {
                    ...
                    while(rest1.next())
                    {
                        ...
                        Tf5.setText(s5);
                        String s6 = rest1.getString("emergency_con");
                        Tf6.setText(s6);
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        try
        {
            if(e.getSource() == btn1 )
            {
                ...
                int tr_id  = Integer.parseInt(ch0.getSelectedItem());
                ...
                //String q = "Update add_trainer SET tr_id ='"+tr_id+"',name ='"+name+"',fath_name ='"+fath_name+"',email = '"+email+"',address ='"+address+"',cont ='"+cont+"',emergency_con = '"+emergency_con+"',tr_cate ='"+tr_cate+"',m_agr ='"+m_agr+"',gender ='"+gender+"',height ='"+height+"',weight'"+weight+"',remarks ='"+remarks+"' where tr_id ='"+tr_id+"'";
                String q = "Update add_trainer SET tr_id=?,name=?,fath_name=?,email=?,address=?,cont=?,emergency_con=?,tr_cate=?,m_agr=?,gender=?,height=?,weight=?,remarks=? where tr_id ="+tr_id;
