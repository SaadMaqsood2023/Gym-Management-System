...
public class Trainer_Attendance extends JFrame implements ActionListener
{
    ...
    Trainer_Attendance()
    {
        ...
        try
        {
            ...
            String q1 ="Select tr_id from add_trainer";
    ...
    // write this mehod out of constructor
    public void actionPerformed(ActionEvent e)
    {
        String tr_id = ch3.getSelectedItem();
        ...
        try
        {
            if(e.getSource() == btn1)
            {
                ...
                String q1 = "Insert into trainer_attend values ('"+tr_id+"','"+morn_atn+"','"+aft_atn+"','"+date+"') ";
                obj1.stm.executeUpdate(q1); //submitting values using executeUpdate and no need Resultset as no values are being extracted
