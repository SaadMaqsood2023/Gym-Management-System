...
{
    String x[] = {"Recepient ID ","Name","Father's name","Email","Address","Contact no","Emergency no","cate","min aggrement","gender","Height","Weight","Remarks" };
    JButton btn1;
    JPanel p1,p2,p3;
    JLabel l1,l2;
    JTextField Tf1;
    ...
    Customer_Information()
    {
        ...
        btn1 = new JButton("Delete Customer");
        btn1.setFont(f);
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if(e.getSource() == btn1 )
        {
            ...
            {
                ConnectionClass obj = new ConnectionClass();
                String q1 = "Delete from add_customer where id = '"+del_id+"'";
